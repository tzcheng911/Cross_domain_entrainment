...
## Load the data
EXP = read.csv("/Users/t.z.cheng/Documents/GitHub/Cross_domain_entrainment/exp9ab/results/EXP9ab_n200_combined_r1_4.csv") 
...
countEXP = filter(EXP, trial_template == "EXP9b_maintaskTrials_rv") 
counting = countEXP %>%
  group_by(stimuli_presented) %>%
  count()
