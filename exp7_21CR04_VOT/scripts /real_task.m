...
close all
clear all
cd /Users/tzu-hancheng/Google_Drive/Academia/2nd_project/stimuli/finalized_stimuli
...
%% factors
VOT = [1:8]; % correspond to 6 VOTs
begin_time = [1,2,3]; % correspond to early(1), ontime(2), late(3) beginning
numTrials= 12; %number of trials per subcondition
file_VOTs = {'VOT_1.wav','VOT_2.wav','VOT_3.wav','VOT_4.wav','VOT_5.wav','VOT_6.wav','VOT_7.wav','VOT_8.wav'};
...
%% questionaires
basicdialog
LanguageBackgroundBDS
save(fname,'subDetails','result','timerecord','basicdialog','LanguageBackgroundBDS');