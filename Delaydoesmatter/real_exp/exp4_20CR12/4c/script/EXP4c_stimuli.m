...
% Modified 2023/11 for exp9b speech modified tone stimuli (upper and lower env)
% Modified 2025/03 for exp10 "a" speech entrainers
...
%% Create context speech + target
fs = 44100; % sampling rate
f0 = 440;
dur = .06; % All stimulus sequences were comprised of a series of 60-ms speech sound "a"
sIOI = .30; % Standard duration
beginning = [-0.09, 0 , 0.09]; 
rampDur = 0.005;
delay = sIOI+beginning; % Delay duration: 2 or 4 or 8 IOI +/- 0.18
...
tone_path = '/Users/t.z.cheng/Documents/GitHub/Cross_domain_entrainment/exp9ab/stimuli/official_stimuli/avg_env_tone_target_85db/';
out_path = ('/Users/t.z.cheng/Documents/GitHub/Cross_domain_entrainment/exp10/stimuli/');

allspeechs = dir(strcat(speech_path,'speech*'));
allmtones = dir(strcat(tone_path,'avg_env*'));

% create tone sequences
for i = 1:length(allmtones)
    name = allmtones(i).name;
...
% create speech sequences
for i = 1:length(allspeechs)
