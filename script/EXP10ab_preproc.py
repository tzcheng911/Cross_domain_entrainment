...
# Add an argument
parser.add_argument('--path', type=str, default="/Users/tzu-hanzoecheng/Documents/GitHub/Cross_domain_entrainment/exp10ab/results/", help='the path having the data')
parser.add_argument('--exp', type=str, choices=['EXP9a', 'EXP9b'], required=True, help='which experiments')
...
Shorter_stimuli = ['Shorter','Back','Beat','Cap','Fat','Lack','Lap','At']
Shorter = []
...
## Code the shorter stimuli e.g. back, beat, lack as 1 and longer stimuli as 8
length = []
