...
% Last Modified by GUIDE v2.5 23-Feb-2012 16:15:19
...
if ( strcmp(get(handles.move1,'String'),'.') || strcmp(get(handles.move2,'String'),'.'))
    beep
elseif (isempty(get(handles.bornin,'String')) || isempty(get(handles.livein,'String')) || ...
        isempty(get(handles.domlang,'String')) || isempty(get(handles.domlearn,'String')) || ...
        isempty(get(handles.domacqage,'String')) || isempty(get(handles.domcomfage,'String')) || ...
        isempty(get(handles.domfulltime,'String')) || isempty(get(handles.domweekend,'String')) || ...
        isempty(get(handles.domonceday,'String')) || isempty(get(handles.nextlang,'String')) || ...
        isempty(get(handles.nextlearn,'String')) || isempty(get(handles.nextacqage,'String')) || ...
        isempty(get(handles.nextcomfage,'String')) || isempty(get(handles.nextfulltime,'String')) || ...
        isempty(get(handles.nextweekend,'String')) || isempty(get(handles.nextonceday,'String')) || ...
        isempty(get(handles.homelang,'String')) || isempty(get(handles.dormlang,'String')) || ...
        isempty(get(handles.mathlang,'String')) || isempty(get(handles.thinklang,'String')) || ...
        isempty(get(handles.accinenglish,'String')) || isempty(get(handles.accinother,'String')) || ...
        isempty(get(handles.lifelang,'String')) || isempty(get(handles.fluencyloss,'String')) || ...
        isempty(get(handles.losslang,'String')) || isempty(get(handles.lossage,'String')) || ...
        isempty(get(handles.otherfluent,'String')) || isempty(get(handles.otherinfo,'String')) )
    beep
...
% hObject    handle to lifelang (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of lifelang as text
%        str2double(get(hObject,'String')) returns contents of lifelang as a double
