...
numTrials= 5; %number of trials per subcondition
...
Screen('FillRect',wPtr,gray);
Screen('DrawText',wPtr,'Press left button for shorter comparison. Press right button for longer comparison.',mx/3,my/2, [0 0 0]);
...
if mod(ntrial,5)==0 
    Screen('TextFont',wPtr, char(font));
    Screen('TextSize', wPtr , 14);
    Screen('DrawText',wPtr,'Take a break! Press space button when you are ready.',mx/2.5, my/2,[0,0,0]);
    Screen('Flip', wPtr);
    KbWait;
