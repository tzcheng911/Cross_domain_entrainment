...
outliers_subj = filter(aovmeans_clean1,outliers=="outliers")
aovmeans_clean2 = filter(aovmeans_clean1, !(sub_id %in% unique(outliers_subj$sub_id)))
...
summary(aov(Shorter~fOnsetR*Explabel+Error(sub_id/fOnsetR),data=filter(aovmeans_clean2,Explabel!="Speech"))) 
summary(aov(Shorter~fOnsetR*Explabel+Error(sub_id/fOnsetR),data=filter(aovmeans_clean2,Explabel!="Tones"))) 
summary(aov(Shorter~fOnsetR*Explabel+Error(sub_id/fOnsetR),data=filter(aovmeans_clean2,Explabel!="ToneasSpeech"))) 
...
eta_squared(aov(fifty~fOnsetR*Explabel+Error(sub_id/fOnsetR),data=aovmeans_clean2))

summary(aov(fifty~fOnsetR*Explabel+Error(sub_id/fOnsetR),data=filter(aovmeans_clean2,Explabel!="Speech"))) 
summary(aov(fifty~fOnsetR*Explabel+Error(sub_id/fOnsetR),data=filter(aovmeans_clean2,Explabel!="Tones"))) 
summary(aov(fifty~fOnsetR*Explabel+Error(sub_id/fOnsetR),data=filter(aovmeans_clean2,Explabel!="ToneasSpeech"))) 

# Speech
t.test(filter(aovmeans_clean2,Explabel=="Speech" & fOnsetR=="early")$fifty,filter(aovmeans_clean2,Explabel=="Speech" & fOnsetR=="ontime")$fifty,paired=T)
t.test(filter(aovmeans_clean2,Explabel=="Speech" & fOnsetR=="early")$fifty,filter(aovmeans_clean2,Explabel=="Speech" & fOnsetR=="late")$fifty,paired=T)
t.test(filter(aovmeans_clean2,Explabel=="Speech" & fOnsetR=="late")$fifty,filter(aovmeans_clean2,Explabel=="Speech" & fOnsetR=="ontime")$fifty,paired=T)
# Tone
t.test(filter(aovmeans_clean2,Explabel=="Tones" & fOnsetR=="early")$fifty,filter(aovmeans_clean2,Explabel=="Tones" & fOnsetR=="ontime")$fifty,paired=T)
t.test(filter(aovmeans_clean2,Explabel=="Tones" & fOnsetR=="early")$fifty,filter(aovmeans_clean2,Explabel=="Tones" & fOnsetR=="late")$fifty,paired=T)
t.test(filter(aovmeans_clean2,Explabel=="Tones" & fOnsetR=="late")$fifty,filter(aovmeans_clean2,Explabel=="Tones" & fOnsetR=="ontime")$fifty,paired=T)
# ToneasSpeech
t.test(filter(aovmeans_clean2,Explabel=="ToneasSpeech" & fOnsetR=="early")$fifty,filter(aovmeans_clean2,Explabel=="ToneasSpeech" & fOnsetR=="ontime")$fifty,paired=T)
t.test(filter(aovmeans_clean2,Explabel=="ToneasSpeech" & fOnsetR=="early")$fifty,filter(aovmeans_clean2,Explabel=="ToneasSpeech" & fOnsetR=="late")$fifty,paired=T)
t.test(filter(aovmeans_clean2,Explabel=="ToneasSpeech" & fOnsetR=="late")$fifty,filter(aovmeans_clean2,Explabel=="ToneasSpeech" & fOnsetR=="ontime")$fifty,paired=T)
